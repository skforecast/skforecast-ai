# Unit test generate_plan ForecastingAssistant
...
# =============================================================================
def test_generate_plan_ValueError_when_forecaster_not_in_candidates():
    """
    Test that generate_plan() raises ValueError when the specified
    ...
    with pytest.raises(ValueError, match=err_msg):
        assistant.generate_plan(profile, steps=10, forecaster="ForecasterRnn")


# =============================================================================
# Tests: basic output
# =============================================================================
def test_generate_plan_output_when_single_series():
    """
    Test that generate_plan() returns a ForecastPlan with correct task_type
...
def test_generate_plan_output_when_forecaster_override():
    """
    Test that generate_plan() honors an explicit forecaster override.
    """
    assistant = ForecastingAssistant()
    profile = assistant.profile(data=df_single, target="sales", date_column="date")
...
def test_generate_plan_output_when_multi_series():
    """
    Test that generate_plan() produces a multi_series plan from a
...
# =============================================================================
def test_generate_plan_output_when_interval_bootstrapping():
    """
    Test that generate_plan() sets interval_method='bootstrapping' for ML
...
def test_generate_plan_output_when_interval_native_for_statistical():
    """
    Test that generate_plan() sets interval_method='native' for
...
def test_generate_plan_output_when_statistical_has_no_lags():
    """
    Test that generate_plan() sets lags, window_features, and transformers
...
def test_generate_plan_output_when_estimator_kwargs_provided():
    """
    Test that generate_plan() passes estimator_kwargs through to the plan.
    """
    assistant = ForecastingAssistant()
    profile = assistant.profile(data=df_single, target="sales", date_column="date")
...
def test_generate_plan_output_when_estimator_override():
    """
    Test that generate_plan() uses the explicitly specified estimator.
    """
    assistant = ForecastingAssistant()
    profile = assistant.profile(data=df_single, target="sales", date_column="date")
    plan = assistant.generate_plan(
...
def test_generate_plan_output_when_no_exog():
    """
    Test that generate_plan() sets use_exog=False when no exogenous
...
def test_generate_plan_output_when_exog_present():
    """
    Test that generate_plan() sets use_exog=True when exogenous variables
