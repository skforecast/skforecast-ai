...
# =============================================================================
# Tests: generate_code_from_plan — basic output
# =============================================================================
def test_generate_code_from_plan_output_when_single_series():
    """
    Test that generate_code_from_plan() produces a valid Python script
    ...
    code = assistant.generate_code_from_plan(profile.data_profile, plan)
...
def test_generate_code_from_plan_output_when_multi_series():
    """
    Test that generate_code_from_plan() produces code containing the
...
def test_generate_code_from_plan_output_when_statistical():
    """
    Test that generate_code_from_plan() produces code for statistical
...
def test_generate_code_from_plan_contains_frequency():
    """
