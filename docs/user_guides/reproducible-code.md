...
The guarantee behind it — *the code shown is exactly the code that ran* — is explained in [How it works & trust](how-it-works-and-trust.md). Here we focus on getting the script and putting it to use.
